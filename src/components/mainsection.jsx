...
function Main() {
    ...
    return (
        <main id="home" className="w-full lg:min-h-screen mt-28 mx-auto px-6 md:px-20 flex scroll-mt-28 mb-3">
            <div className="container lg:min-h-screen w-full mx-auto flex flex-col md:flex-row justify-center md:justify-between gap-10">
