...
function SecThree() {
    return (
        <section id="contact" className="w-full scroll-mt-28 my-10 flex justify-center items-center">
            <div className="container w-full flex flex-col justify-center items-center gap-7">
             <Headsection text1={"Say Hello"} text2={"Get In Touch"} text3={"Open to freelance projects, internships, and full-time opportunities. Let's build something great together."}/>
                <div className="w-full flex flex-col md:flex-row gap-7 text-sm px-5">
                    <div className="bg-linear-to-r from-blue-900 to-purple-900 ring-1 ring-blue-500 flex flex-col items-start gap-6
                    hover:shadow-lg hover:shadow-gray-400 hover:-translate-y-2 transition-all duration-300 p-4 rounded-lg h-[420px] w-full md:w-1/2">
